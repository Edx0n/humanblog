...
// Gerenciador de rotas para a raiz ("/")
...
app.post("/login", async (req, res) => {
  ...
  // Verifique se userDoc é null, o que significa que nenhum usuário foi encontrado com o userName fornecido
  if (!userDoc) {
...
app.put("/post", uploadMiddleware.single("file"), async (req, res) => {
  ...
  jwt.verify(token, secret, {}, async (err, info) => {
    ...
    // findByIdAndUpdate para atualizar o documento
